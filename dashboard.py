...
# Tabs
tab_scraper, tab_explorer, tab_scheduler, tab_session, tab_cerebro, tab_oracle, tab_api, tab_genesis, tab_alchemy, tab_timemachine, tab_nexus = st.tabs([
    "🚀 Scraper Engine", "📊 Data Explorer", "👁️ The Watcher", "🔐 Session Manager", "🧠 Cerebro Agent", "🔮 The Oracle", "🧞 Gen-API", "🧬 Genesis", "⚗️ Alchemy", "⏳ Time Machine", "🔗 Nexus"
])
